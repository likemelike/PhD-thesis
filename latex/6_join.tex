...
\begin{figure}
    \centering
    \includegraphics[width=0.3\columnwidth]{fig/section6/lens.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\columnwidth]{fig/section6/overall example.png}
...
\begin{figure*}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{fig/section6/ball-tree.pdf}
...
\begin{figure}[htbp]
    \centering
\includegraphics[width=0.8\textwidth]{fig/section6/mtree.pdf}
\caption{M*-树的结构}
\label{fig:m*-tree}
\end{figure}
...
\begin{figure}[tb]
    \centering
    \subfloat[Geolife]{
        \includegraphics[width=0.22\textwidth]{fig/section6/geo-sim-ftime.png}
        \label{geo-sim-totaltime}
    }%
    \subfloat[Porto]{
        \includegraphics[width=0.228\textwidth]{fig/section6/pt-sim-ftime.png}
...
\begin{figure}[tb]
    \centering
    \subfloat[Geolife]{
        \includegraphics[width=0.23\textwidth]{fig/section6/geo-num-access.png}
        \label{geo-num-access}
    }%
    \subfloat[Porto]{
        \includegraphics[width=0.22\textwidth]{fig/section6/pt-num-access.png}
        \label{pt-num-access}
    }%
    \caption{移动对象数量对节点访问次数的影响}
...
\begin{figure}[tb]
    \centering
    \subfloat[Geolife]{
        \includegraphics[width=0.22\textwidth]{fig/section6/geo-k-ftime.png}
    }%
    \subfloat[Porto]{
        \includegraphics[width=0.22\textwidth]{fig/section6/pt-k-ftime.png}
    }%
    \caption{$k$ 的影响}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.25\textwidth]{fig/section6/sample.pdf}
